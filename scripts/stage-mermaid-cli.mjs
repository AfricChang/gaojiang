...
const launcherPath = path.join(resourcesDir, "gaojiang-mermaid.cmd");
...
async function writeRuntimeReadme() {
    const readme = [
        "# Gaojiang Mermaid CLI Runtime",
        "",
        "This directory is generated by `pnpm cli:stage` and bundled with the Gaojiang desktop application.",
        "",
        "Use `..\\gaojiang-mermaid.cmd` from the installed application resources directory.",
        "",
...
if (process.platform !== "win32") {
    console.log("Skipping Gaojiang Mermaid CLI staging because the product CLI is currently Windows-only.");
    process.exit(0);
}
...
console.log(`Staged Gaojiang Mermaid CLI runtime at ${runtimeDir}`);
